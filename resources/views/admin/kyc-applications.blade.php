    ...
    <div class="main-panel ">
        <div class="content ">
            <div class="page-inner">
                ...
                <div class="mt-2 mb-4 admin-detail-head d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="card p-md-4 p-2 ">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <img src="{{ public_storage_url($kyc->frontimg) }}" alt=""
                                            class="w-50 img-fluid d-block">
                                        <small class="text-muted">Front View of Document</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <img src="{{ public_storage_url($kyc->backimg) }}" alt=""
                                            class="w-50 img-fluid d-block">
